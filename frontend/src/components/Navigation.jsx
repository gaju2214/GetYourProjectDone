...
//                   <Home className="h-4 w-4 sm:h-5 sm:w-5 hover:scale-110 hover:text-orange-500 transition-transform duration-300" />
//                 </Button>
//               </Link>

//               <Link to="/cart" className="flex-shrink-0">
//                 <Button variant="ghost" size="icon" className="relative">
//                   <ShoppingCart className="h-4 w-4 sm:h-5 sm:w-5 hover:scale-110 hover:text-orange-500 transition-transform duration-300" />
//                   {state.itemCount > 0 && (
//                     <Badge className="absolute top-0 right-3 h-4 w-4 rounded-full flex items-center justify-center text-[9px] bg-black text-white shadow-md">
//                       {state.itemCount}
//                     </Badge>
//                   )}
//                 </Button>
...
//                     <Button variant="ghost" size="icon">
//                       <User className="h-4 w-4 sm:h-5 sm:w-5 hover:scale-110 hover:text-orange-500 transition-transform duration-300" />
//                     </Button>
//                   </Link>
//                   <Button
...
//                     <Menu className="h-5 w-5 sm:h-6 sm:w-6 hover:scale-110 hover:text-orange-500 transition-transform duration-300" />
//                   </Button>
//                 </SheetTrigger>
//                 <SheetContent
//                   side="right"
...
//                     <Link to="/" onClick={() => setIsMenuOpen(false)} className="text-gray-800 hover:text-orange-500 transition-colors duration-300">
//                       Home
//                     </Link>
//                     <Link to="/categories" onClick={() => setIsMenuOpen(false)} className="text-gray-800 hover:text-orange-500 transition-colors duration-300">
//                       Categories
//                     </Link>
//                     <Link to="/cart" onClick={() => setIsMenuOpen(false)} className="text-gray-800 hover:text-orange-500 transition-colors duration-300">
//                       Cart
//                     </Link>

//                     {user ? (
//                       <>
//                         <Link to="/account" onClick={() => setIsMenuOpen(false)} className="text-gray-800 hover:text-orange-500 transition-colors duration-300">
//                           Profile
//                         </Link>
//                         <button
//                           onClick={() => {
...
//                       </>
//                     ) : (
//                       <Link to="/auth/login" onClick={() => setIsMenuOpen(false)} className="w-full bg-orange-500 hover:bg-orange-600 text-white rounded-md py-2 text-center shadow-md transition-all duration-300">
//                         Login
//                       </Link>
//                     )}
//                   </div>
      ...
      <nav className={`sticky top-0 z-50 w-full bg-white/90 backdrop-blur transition-shadow duration-300 ${hasShadow ? "shadow-md" : ""}`}>
        <div className="flex items-center justify-between gap-y-2 h-auto py-2">
          ...
          <div className="flex items-center justify-between w-full">
            ...
            {/* Right Side Buttons (Icons) */}
            {/* Home Icon */}
            <div className="flex items-center gap-5 sm:gap-2 px-2 py-1 flex-shrink-0 max-w-full overflow-hidden">
              <Link to="/" className="block md:hidden flex-shrink-0">
                <Button
                  variant="ghost"
                  size="icon"
