...
const ProjectAdminPanel = () => {
  ...
  const handleAddCategory = async () => {
    ...
    try {
      ...
      setCategories((prev) => [...prev, res.data]); // Add new category to state
      setCategoryName("");
  ...
  const handleAddSubcategory = async () => {
    ...
    try {
      ...
      setSubcategories((prev) => [...prev, res.data]); // Add new subcategory to state
      setSubcategoryName("");
      setSelectedCategoryId("");
    ...
    <div className="p-6 max-w-3xl mx-auto space-y-8">
      ...
      <div className="border p-4 rounded">
        ...
        <select
          ...
          disabled={!projectData.categoryId} // disabled until category is selected
        >
          <option value="">Select Subcategory</option>
          {subcategories.map((sub) => (
            <option key={sub.id} value={sub.id}>
