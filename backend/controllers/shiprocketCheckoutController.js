...
exports.receiveCheckoutOrder = async (req, res) => {
  try {
    ...
    const newOrder = await Order.create({
      ...
      address: (shipping_address && shipping_address.address) || (billing_address && billing_address.address) || null,
      city: (shipping_address && shipping_address.city) || (billing_address && billing_address.city) || null,
      pincode: (shipping_address && shipping_address.pincode) || (billing_address && billing_address.pincode) || null,
      state: (shipping_address && shipping_address.state) || (billing_address && billing_address.state) || null,
      country: (shipping_address && shipping_address.country) || (billing_address && billing_address.country) || null,
